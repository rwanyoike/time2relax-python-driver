...
def test_get_database_host():
    assert (
        utils.get_database_host("https://foobar.com:5984/testdb")
        == "https://foobar.com:5984"
    )
    assert (
        utils.get_database_host("http://u:p@foo.com/a/b/index.html?hey=yo")
        == "http://u:p@foo.com"
    )
...
def test_get_database_name():
    ...
    assert (
        utils.get_database_name("https://u:p@foo.com/a/b/index.html?hey=yo")
        == "index.html"
    )
