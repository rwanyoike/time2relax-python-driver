...
# Insert the project root dir as the first element in the PYTHONPATH. This lets
# us ensure that the source package is imported, and that its version is used.
...
project = 'time2relax'
copyright = '2016, Raymond Wanyoike'
